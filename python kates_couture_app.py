    ...
    while True:  
        ...
        while True:  
            ...
            if top_level_category:  
                ...
                print("Invalid choice. Please enter 1, 2, or 3 (or 0 to go back).")  
        ...
        if top_level_category == "Top":  
            ...
            if garment_name == "Pants":  
                while True:  
                    ...
                    if pants_style_choice:  
                        ...
                        print("Invalid choice. Please enter a number from 1 to 6 (or 0 to go back).")  
            ...
            while True:  
                ...
                print("3. Evening Top/Evening Bottoms")  
                print("4. Evening Top/Evening Shorts")  
                print("5. Camisole/Evening Bottoms")  
                print("6. Camisole/Evening Shorts")  

                combo_choice_num = input("Simply pick a number (e.g., 2.1 for Vest/Blazer/Pants Suit, or 0 to go back): ").strip()  
                ...
                if combo_choice_num == "1":  
                    ...
                    print("Invalid choice. Please enter a valid number (e.g., 1, 2.1, 3, etc., or 0 to go back).")  
                    continue  
        ...
        elif garment_name == "Camisole" or "Suit (Camisole" in garment_name:  
