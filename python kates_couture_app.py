...
Your journey to a perfectly custom-made garment starts here.")   
    ...
    all_garment_details = {   
        ...
        "Evening": {"base_cost": 35.00, "base_yardage": 1.5, "measurements": ["Bust/Chest", "Across Back/Shoulder to Shoulder", "Neck/Collar Circumference", "Waist", "Mid-Torso", "Shoulder to Waist", "Neck to top of derriere/backside"]},   
        ...
        "Camisole and Sweats": {"base_cost": 81.00, "base_yardage": 2.8, "measurements": ["Bust/Chest", "Waist", "Mid-Torso", "Shoulder to Waist", "Shoulder to Bust Apex", "Hips", "Inseam", "Outseam"]}, # New combo
        "Camisole and Slacks": {"base_cost": 81.00, "base_yardage": 2.8, "measurements": ["Bust/Chest", "Waist", "Mid-Torso", "Shoulder to Waist", "Shoulder to Bust Apex", "Hips", "Inseam", "Outseam"]}, # New combo
        "Camisole and Casual Pants": {"base_cost": 81.00, "base_yardage": 2.8, "measurements": ["Bust/Chest", "Waist", "Mid-Torso", "Shoulder to Waist", "Shoulder to Bust Apex", "Hips", "Inseam", "Outseam"]}, # New combo
        "Camisole and Casual Shorts": {"base_cost": 45.00, "base_yardage": 1.8, "measurements": ["Bust/Chest", "Waist", "Mid-Torso", "Shoulder to Waist", "Shoulder to Bust Apex", "Hips", "Inseam", "Outseam"]}, # New combo
    }   
    ...
    measurement_descriptions = {   
        ...
        "Neck to top of derriere/backside": "Measure from the prominent bone at the base of your neck (center back) straight down your spine to the top curve of your derriere/backside."   
    }   
...
Select Your Garment Category")   
        top_level_categories = {   
            "1": "Top",   
            "2": "Bottom",   
            "3": "Dress", # Moved Dress to its own category
            "4": "Combo"   # Combo is now 4
        }   

        while True:   
            for num, category in top_level_categories.items():   
                print(f"{num}. {category}")   
            category_choice_num = input("Simply pick a number (or 0 to go back): ").strip()   
            ...
            if top_level_category:   
                ...
                print("Invalid choice. Please enter 1, 2, 3, or 4 (or 0 to go back).")   
...
Select Your Top Garment")   
                ...
                top_choice_num = input("Simply pick a number (or 0 to go back): ").strip()   
                if top_choice_num == "0":   
...
Select Collar Type:")   
                    ...
                    collar_choice_num = input("Simply pick a number (or 0 to go back): ").strip()   
                    if collar_choice_num == "0":   
                        continue # Go back to top garment selection   
...
Select Your Bottom Garment")   
                ...
                bottom_choice_num = input("Simply pick a number (or 0 to go back): ").strip()   
                if bottom_choice_num == "0":   
                    continue # Go back to category selection   
                ...
                if chosen_garment_key:   
                    ...
                    print("Invalid choice. Please enter a number from 1 to 3 (or 0 to go back).")   
...
Select Your Pants Style")   
                    pants_styles = {   
                        ...
                        "5": "Evening",   
                        "6": "Leggings",
                        "7": "Casual" # New casual pants style
                    }   
                    for num, style_name in pants_styles.items():   
                        print(f"{num}. {style_name}")   

                    pants_style_choice_num = input("Simply pick a number (or 0 to go back): ").strip()   
                    if pants_style_choice_num == "0":   
                        continue # Go back to bottom garment selection   
...
Select Your Shorts Style")   
                    shorts_styles = {   
                        ...
                        "2": "Sweats",   
                        "3": "Evening",
                        "4": "Casual" # New casual shorts style
                    }   
                    for num, style_name in shorts_styles.items():   
                        print(f"{num}. {style_name}")   

                    shorts_style_choice_num = input("Simply pick a number (or 0 to go back): ").strip()   
                    if shorts_style_choice_num == "0":   
                        continue # Go back to bottom garment selection   
...
Select Your Skirt Style")   
                    ...
                    skirt_style_choice_num = input("Simply pick a number (or 0 to go back): ").strip()   
                    if skirt_style_choice_num == "0":   
                        continue # Go back to bottom garment selection   
                    skirt_style_choice = skirt_styles.get(skirt_style_choice_num)   
                    if skirt_style_choice:   
                        break   
                    else:   
                        print("Invalid choice. Please enter a number from 1 to 5 (or 0 to go back).")   
...
Select Your Dress")
                ...
                for num, option in dress_options.items():
                    print(f"{num}. {option}")
                
                dress_choice_num = input("Simply pick a number (or 0 to go back): ").strip()
                if dress_choice_num == "0":
                    continue # Go back to category selection
                chosen_garment_key = dress_options.get(dress_choice_num)
                if chosen_garment_key:
                    garment_name = chosen_garment_key
                    garment_details = get_garment_details(garment_name)
                    base_cost = garment_details["base_cost"]
                    ...
                    print("Invalid choice. Please enter 1 (or 0 to go back).")
...
Select Your Combo Garment")   
                ...
                print(" 1.2. Vest/Blazer")   
                print(" 1.3. Vest/Pants")   
                print(" 1.4. Blazer/Pants")   
                print("2. Evening Top/Evening Bottoms")   
                print("3. Evening Top/Evening Shorts")   
                print("4. Camisole/Evening Bottoms")   
                print("5. Camisole/Evening Shorts")
                print("6. Camisole/Sweats") # New combo
                print("7. Camisole/Slacks") # New combo
                print("8. Camisole/Casual Pants") # New combo
                print("9. Camisole/Casual Shorts") # New combo

                combo_choice_num = input("Simply pick a number (e.g., 1.1 for Vest/Blazer/Pants Suit, or 0 to go back): ").strip()   
                if combo_choice_num == "0":   
                    continue # Go back to category selection   

                if combo_choice_num == "1.1":   
                    garment_name = "Suit (Vest/Blazer/Pants)"   
                elif combo_choice_num == "1.2":   
                    garment_name = "Suit (Vest/Blazer)"   
                elif combo_choice_num == "1.3":   
                    garment_name = "Suit (Vest/Pants)"   
                elif combo_choice_num == "1.4":   
                    garment_name = "Suit (Blazer/Pants)"   
                elif combo_choice_num == "2":   
                ...
                elif combo_choice_num == "6": # New combo
                    garment_name = "Camisole and Sweats"
                elif combo_choice_num == "7": # New combo
                    garment_name = "Camisole and Slacks"
                elif combo_choice_num == "8": # New combo
                    garment_name = "Camisole and Casual Pants"
                elif combo_choice_num == "9": # New combo
                    garment_name = "Camisole and Casual Shorts"
                else:   
                    print("Invalid choice. Please enter a valid number (e.g., 1.1, 2, etc., or 0 to go back).")   
                    continue   
...
Button Placement")   
                ...
                button_choice = input("Simply pick a number (or 0 to go back): ").strip()   
                if button_choice == "0":   
                    continue # Go back to garment selection for top/combo   
                if button_choice == "1":   
                    ...
                    print("Invalid choice. Please enter 1 or 2 (or 0 to go back).")   
...
Select Dress Waistline Option:")   
                ...
                for num, option in dress_waistline_options.items():   
                    print(f"{num}. {option}")   
                waistline_choice_num = input("Simply pick a number (or 0 to go back): ").strip()   
                if waistline_choice_num == "0":   
                    continue # Go back to garment selection for combo   
        ...
        if garment_name in ["Blouse", "Button Front", "Crop", "Dress"] or \
            "Evening Top" in garment_name or "Camisole" in garment_name or \
            "Suit (" in garment_name:   
            sleeves_applicable = True   

        if garment_name == "Blazer" or "Suit (Vest/Blazer" in garment_name:   
            sleeve_chosen_type = "Long"   
        elif garment_name == "Camisole" or "Camisole and " in garment_name: # Updated to include new camisole combos
            ...
            while True:   
                ...
                sleeve_choice = input(f"{sleeve_choice_prompt} (Short, Long, None, or 0 to go back): ").strip().lower()   
                if sleeve_choice == "0":   
                    continue # Go back to previous customization option   
                if sleeve_choice in ["long", "l"]:   
                    ...
                    print("Invalid sleeve choice. Please enter 'Short', 'Long', 'None', or their single letter abbreviations (S, L, N), or 0 to go back.")   
...
Vest Bottom Style")   
                ...
                print("4. Flat Bottom")   
                style_choice = input("Simply pick a number (or 0 to go back): ").strip()   
                if style_choice == "0":   
                    continue # Go back to previous customization option   
                if style_choice == "1":   
...
--- Additional Customizations ---")   
        ...
        while True:   
            complex_design_prompt_input = input("Let's really slay! (yes/no, or 0 to go back): ").strip().lower()   
            if complex_design_prompt_input == "0":   
                continue # Go back to previous customization option   
            if complex_design_prompt_input in ["yes", "y", "no", "n"]:   
                break   
            else:   
...
Options:")   
                ...
                if choice == "0":   
                    break # Go back to "Let's really slay!" prompt   
                if choice in ["done", "d"]:   
                    break   
...
What kind of pockets would you like?")   
                                ...
                                pocket_type_choice = input("Simply pick a number (1-3, or 0 to go back): ").strip()   
                                if pocket_type_choice == "0":   
                                    # This '0' will only go back to the complex design options, not remove the pocket choice.   
                                    # A more robust solution for undoing choices would be needed for that.   
                                    break   
                                if pocket_type_choice == "1":   
                                    ...
                                    print("Invalid pocket choice, defaulting to Standard Patch Pockets. Please enter 1-3 or 0 to go back.")   
                        ...
                        print(f"'{chosen_option_name}' already selected. Please choose another option or 'done'/'d' (or 0 to go back).")   
                else:   
                    print("Invalid choice. Please enter a number from the list or 'done'/'d' (or 0 to go back).")   
...
Select Fabric for {part_of_garment}:")   
                ...
                fabric_choice_num = input("Simply pick a number (or 0 to go back): ").strip()   
                if fabric_choice_num == "0":   
                    return "GO_BACK", "N/A", 0.0 # Special return to signal going back   
                ...
                if fabric_name:   
                    ...
                    print("Invalid choice. Please enter a valid number from the list (or 0 to go back).")   

            while True:   
                fabric_style_choice = input("Choose fabric style (1. Solid Color / 2. Print/Pattern, or 0 to go back): ").strip()   
                if fabric_style_choice == "0":   
                    return "GO_BACK", "N/A", 0.0 # Special return to signal going back   
                if fabric_style_choice == "1":   
                    ...
                    print("Invalid choice. Please enter 1 for Solid Color or 2 for Print/Pattern (or 0 to go back).")   

            return fabric_name, fabric_style_type, price_per_yard   

        fabric_selection_successful = False   
        while not fabric_selection_successful:   
            chosen_fabrics = [] # Reset chosen fabrics if we go back   
            if "Suit (" in garment_name:   
                vest_front_fabric_data = None   
                vest_back_fabric_data = None   
                blazer_fabric_data = None   
                pants_fabric_data = None   
                lining_fabric_data = None   

                if "Vest" in garment_name:   
                    front_fabric_name, front_fabric_style, front_price_per_yard = get_fabric_details("Vest Front")   
                    if front_fabric_name == "GO_BACK": continue   
                    ...
                    if back_fabric_name == "GO_BACK": continue   
                ...
                if "Blazer" in garment_name:   
                    ...
                    if blazer_fabric_name == "GO_BACK": continue   
                ...
                if "Pants" in garment_name:   
                    ...
                    if pants_fabric_name == "GO_BACK": continue   
...
Now, choose the fabric for the Lining.")   
                ...
                fabric_selection_successful = True   

            elif garment_name in ["Evening Top and Pants", "Evening Top and Shorts", "Camisole and Evening Pants", "Camisole and Evening Shorts", "Camisole and Sweats", "Camisole and Slacks", "Camisole and Casual Pants", "Camisole and Casual Shorts"]: # Updated to include new camisole combos
                top_type_for_fabric = "Evening Top" if "Evening Top" in garment_name else "Camisole Top"   
                bottom_type_for_fabric = "Pants" if "Pants" in garment_name or "Slacks" in garment_name or "Sweats" in garment_name else "Shorts" # Adjusted for new combos

                top_fabric_name, top_fabric_style, top_price_per_yard = get_fabric_details(top_type_for_fabric)   
                if top_fabric_name == "GO_BACK": continue   
                ...
                if bottom_fabric_name == "GO_BACK": continue   
...
Now, choose the fabric for the Lining.")   
                ...
                main_fabric_name, main_fabric_style_type, main_price_per_yard = get_fabric_details("your garment")   
                if main_fabric_name == "GO_BACK": continue   
                chosen_fabrics.append({"part": "Main", "name": main_fabric_name, "style": main_fabric_style_type, "price_per_yard": main_price_per_yard})   

                if sleeve_chosen_type in ["Long", "Short"] and garment_name not in ["Blazer", "Vest"] and "Suit (" not in garment_name:   
                    sleeve_fabric_name, sleeve_fabric_style_type, sleeve_price_per_yard = get_fabric_details("Sleeves")   
                    if sleeve_fabric_name == "GO_BACK": continue   
...
Now, choose the fabric for the Lining.")   
        ...
        if "Suit (" in garment_name:   
            ...
            bottom_base_yardage = all_garment_details["Pants"]["base_yardage"] if "Pants" in garment_name or "Slacks" in garment_name or "Sweats" in garment_name else all_garment_details["Shorts"]["base_yardage"] # Adjusted for new combos
            ...
            sleeve_fabric_data = next((f for f in chosen_fabrics if f["part"] == "Sleeves"), None)   
            lining_fabric_data = next((f for f in chosen_fabrics if f["part"] == "Lining"), None)   

            main_fabric_yardage = final_yardage_single_garment   
            sleeve_yardage_factor = 0.25 if sleeve_chosen_type == "Short" else 0.5   

            if main_fabric_data:   
                if sleeve_fabric_data: # If sleeves have separate fabric, subtract their yardage from main   
                    main_fabric_yardage -= (estimated_yardage * sleeve_yardage_factor)   
                total_fabric_cost_single_garment += main_fabric_yardage * main_fabric_data["price_per_yard"]   

            if sleeve_fabric_data:   
                total_fabric_cost_single_garment += (estimated_yardage * sleeve_yardage_factor) * sleeve_fabric_data["price_per_yard"]   
        ...
        while True:   
            try:   
                quantity_str = input(f"How many of this '{garment_name}' would you like to order? (Enter a number, or 0 to go back): ").strip()   
                if quantity_str == "0":   
                    # This will break out of the quantity loop and effectively go back to the start of the main garment loop.   
                    # This means all choices made for the current garment will be reset.   
                    break   
                ...
                print("Invalid input. Please enter a whole number (or 0 to go back).")   

        if quantity_str == "0": # If user entered 0 to go back, restart the main loop   
            continue   
        ...
        current_garment_order = {   
            ...
            "total_fabric_cost_per_unit": total_cost_single_garment,   
            "quantity": quantity   
        }   
...
'{quantity} x {garment_name}' added to your order!")   
        ...
        add_another = ""   
        while True:   
            add_another = input("Would you like to add another garment to your order? (yes/no, or 0 to go back): ").strip().lower()   
            if add_another == "0":   
                # If 0 is entered here, it should remove the last added garment and allow re-selection.   
                if completed_orders:   
                    removed_order = completed_orders.pop()   
                    print(f"Removed '{removed_order['quantity']} x {removed_order['garment_name']}' from your order.")   
                    # Rebuild all_required_measurements as a garment was removed   
                    all_required_measurements.clear()   
                    for order in completed_orders:   
                        for meas in order["required_measurements_for_this_garment"]:   
                            all_required_measurements.add(meas)   
                    # This 'continue' will effectively restart the main garment selection loop   
                    continue   
                else:   
                    print("No garments to go back on. Please add a garment or exit.")   
                    continue # Keep prompting for add another   
            elif add_another in ["yes", "y"]:   
                break   
    ...
    potential_combos = {   
        ...
        "Camisole and Sweats": {"components": ["Camisole", "Pants"], "combo_cost_factor": 0.90}, # New combo
        "Camisole and Slacks": {"components": ["Camisole", "Pants"], "combo_cost_factor": 0.90}, # New combo
        "Camisole and Casual Pants": {"components": ["Camisole", "Pants"], "combo_cost_factor": 0.90}, # New combo
        "Camisole and Casual Shorts": {"components": ["Camisole", "Shorts"], "combo_cost_factor": 0.90}, # New combo
    }   
...
--- Special Offer! ---")   
                ...
                if confirm_combo in ["yes", "y"]:   
                    ...
                    for original_order_item in completed_orders:   
                        ...
                        # If quantity is 1, it's consumed for the combo, so don't add it back to new_completed_orders.   
                        # If it's not a component needed for the combo, or already consumed, add it back.   
                        elif current_garment_name not in components_needed or consumed_items_info[current_garment_name] >= 1:   
...
Measurement: {measurement_name}")   
                    ...
                    if value_str == "0":   
                        ...
                        return run_kates_couture_app() # Restart the entire application   
...
--- Garment Details (Customer View) ---")   
            for i, order in enumerate(completed_orders):   
                ...
                if "Suit (" in order['garment_name']:   
                    ...
                    sleeve_fabric = next((f for f in order['chosen_fabrics'] if f["part"] == "Sleeves"), None)   
                    if sleeve_fabric:   
                        description_lines.append(f" Sleeves: {sleeve_fabric['name']} {sleeve_fabric['style']}")   
